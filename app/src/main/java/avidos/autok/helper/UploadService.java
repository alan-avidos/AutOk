...
import avidos.autok.activity.MainActivity;
...
public class UploadService extends BaseTaskService {
    ...
    public static final String EXTRA_UPLOAD_FILENAME = "extra_download_filename";
    public static final String EXTRA_STORAGE_REFERENCE = "extra_storage_reference";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_UPLOAD.equals(intent.getAction())) {
            ...
            String path = intent.getStringExtra(EXTRA_UPLOAD_FILENAME);
            if (intent.hasExtra(EXTRA_STORAGE_REFERENCE))
                mStorageRef = FirebaseStorage.getInstance().getReference().child(intent.getStringExtra(EXTRA_STORAGE_REFERENCE));
    ...
    private void uploadFromUri(final Uri fileUri, final String fileName) {
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        int icon = success ? R.drawable.ic_done_white_24dp : R.drawable.ic_error_white_24dp;
